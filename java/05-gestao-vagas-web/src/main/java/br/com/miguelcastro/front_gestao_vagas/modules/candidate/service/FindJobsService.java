package br.com.miguelcastro.front_gestao_vagas.modules.candidate.service;

import br.com.miguelcastro.front_gestao_vagas.modules.candidate.dto.JobDTO;
...
public class FindJobsService {
  ...
  public List<JobDTO> execute(String token, String filter) {
    ...
    UriComponentsBuilder builder =
        UriComponentsBuilder.fromHttpUrl(url).queryParam("filter", filter);
